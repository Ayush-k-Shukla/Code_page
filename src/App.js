...
function App() {
  ...
  return (
    <Router>
      ...
      <section data-aos="fade-up" class="career-section">
        <div class="container">
          <div class="row">
            <div class="col-sm-6">
              <h2>
          ...
          <div class="row middel-flex">
                ...
                <div class="col-md-6 col-sm-6 col-12">
                  <div data-aos="fade-up" class="your-box">
                    ...
                    <p>
                      ...
                      into electronic typesetting and more.
                    </p>
                  </div>
                </div>
                <div class="col-md-6 col-sm-6 col-12">
            ...
            <div class="col-md-6 col-sm-12" id="your-life-class">
              ...
              <p>
                ...
                ceative induviduels who are willing to dedicate themselves to
                providing innovative products and servies for our clients.
              </p>
              <p>
                Besides getting the opportunity ot unlock your true potential,
                at EleHirely you can also network with some of the talented
                people in the industry, go on annual picnices ouside the country
